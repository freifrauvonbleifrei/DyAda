...
from dyada.discretization import Discretization, discretization_to_location_stack
...
def plot_location_stack_tikz(discretization: Discretization, filename="location_stack"):
    ...
    assert descriptor.get_num_dimensions() == 2
    location_stack = discretization_to_location_stack(discretization)
