...
from dyada.linearization import TrackToken, location_code_from_branch
...
class PlannedAdaptiveRefinement:
    ...
    def correct_index_mapping(
        ...
        while one_after_last_considered_index < len(old_descriptor):
            marked_ancestor_index = self.get_next_index_to_refine(
                one_after_last_considered_index
            )
